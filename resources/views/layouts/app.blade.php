...
<head>
    ...
    <!-- login -->
    <link rel="stylesheet" type="text/css" href="{{ url('/') }}/bootstrap/vendor/bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="{{ url('/') }}/bootstrap/fonts/font-awesome-4.7.0/css/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="{{ url('/') }}/bootstrap/fonts/iconic/css/material-design-iconic-font.min.css">
